...
Globals.fpsStats.dom.style.cssText = "position:absolute;top:100px;left: 250px;scale:2";
//check if player is on mobile
    //if yes
        //change config.logicalWidth - 2160;
//okay
if(window.innerWidth>window.innerHeight){
  //  console.log("desktop")
    config.logicalHeight = 2160;
    config.logicalWidth= 3840;
}
if(window.innerWidth<window.innerHeight){
  //  console.log("mobile")
    config.logicalHeight = 3840;
    config.logicalWidth= 2160;
}
